...
<head>
     ...
     <style>
        ...
        /* Hide all category groups except the first one */
        .category-group {
            display: none;
        }
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    @if ($category->icon)
                    <img src="{{ asset('storage/' . $category->icon) }}" alt="{{ $category->name }}" style="max-width: 100px;">
                    @else
                    No Icon Available
                    @endif
                </td>
...
document.addEventListener('DOMContentLoaded', function() {
    const categoryGroups = document.querySelectorAll('.categories-container');
    let currentIndex = 0;
    ...
    document.querySelector('.next').addEventListener('click', function() {
        currentIndex = (currentIndex + 1) % categoryGroups.length;
        showGroup(currentIndex);
    });

    document.querySelector('.prev').addEventListener('click', function() {
        currentIndex = (currentIndex - 1 + categoryGroups.length) % categoryGroups.length;
        showGroup(currentIndex);
    });
