...
/* ROOT VARIABLE  */
/* Ajoutez ce style pour le formulaire */
form {
            max-width: 400px;
            margin: 2rem auto;
            padding: 1.5rem;
        ...
        form label {
            ...
            font-weight: bold;
            color: var(--color-dark); /* Couleur du texte du label */
        }
        ...
        form select {
            ...
            font-size: 1rem; /* Taille de la police des champs de saisie */
            color: var(--color-dark); /* Couleur du texte des champs de saisie */
        }
        ...
        form button:hover {
            background-color: var(--color-primary-variant); /* Couleur au survol du bouton */
        }.product-form {
    max-width: 400px;
    margin: 2rem auto;
    padding: 1.5rem;
...
/* Pour espacer les éléments du formulaire */
.product-form label,
.product-form input,
.product-form select,
.product-form button {
...
/* Ajoutez ce style si vous souhaitez centrer le formulaire dans la page */
.category-form {
    display: flex;
    flex-direction: column;
    align-items: center;
...
/* Ajoutez ce style pour espacer les éléments du formulaire */
.category-form label,
.category-form input,
    ...
    Profile
     ...
     <div class="container">
          ...
          <form action="{{ route('categories.update', $category->id) }}" method="POST" class="category-form">
            @csrf
            @method('PATCH') <!-- Utilisez PATCH pour les mises à jour -->

            <label for="name">Category Name:</label>
            <input type="text" id="name" name="name" value="{{ $category->name }}" required>

            <label for="icon">Category Icon (URL):</label>
            <input type="text" id="icon" name="icon" value="{{ $category->icon }}">

            <label for="num_products">Number of Products:</label>
            <input type="number" id="num_products" name="num_products" value="{{ $category->num_products }}" required>
        ...
        <script>
            // JavaScript code to toggle the 'active' class on the aside element
